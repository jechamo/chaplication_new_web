...
// - Carga imágenes reales desde /public/images (Next/Vite/CRA)
// REGLA: coloca tus archivos definitivos en public/images y usa exactamente los nombres sugeridos.

// Helper para resolver rutas de imágenes desde `public/images` en múltiples toolchains
